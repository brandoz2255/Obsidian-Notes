...
- We will need to modify the const logs and will need to modify  the get level color just to display the type of logs its displaying 
- [[Prompt for modification]]
- [[What to do to the page]] 
- [[SSE for web apps]]
- [[Nvim]]
- [[lazyvim]]
- [[CORS Flask security measure in Browsers]]